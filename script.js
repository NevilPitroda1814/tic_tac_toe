function checkWon() 
{
	...
	if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' ||
		...
		document.getElementById('print').innerHTML = "Player X won";
        document.getElementById('b1').style.color = "limegreen";
        document.getElementById('b4').style.color = "limegreen";
        document.getElementById('b7').style.color = "limegreen";
		...
		document.getElementById('print').innerHTML = "Player X won";
        document.getElementById('b7').style.color = "limegreen";
        document.getElementById('b8').style.color = "limegreen";
        document.getElementById('b9').style.color = "limegreen";
        ...
        document.getElementById('b9').style.color = "limegreen";
        document.getElementById('b3').style.color = "limegreen";
        document.getElementById('b6').style.color = "limegreen";
		...
		document.getElementById('print').innerHTML = "Player X won";
        document.getElementById('b9').style.color = "limegreen";
        document.getElementById('b5').style.color = "limegreen";
        document.getElementById('b1').style.color = "limegreen";
